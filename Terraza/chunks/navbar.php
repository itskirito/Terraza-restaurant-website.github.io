<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="/Terraza" class="brand-logo">Terazza Restaurant</a>
		      <a href="/Terraza" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/Terraza" class="hvr-grow">Home</a></li>
		        <li><a href="/Terraza/about-terazza-restaurant.php" class="hvr-grow">About Us</a></li>
		        <li><a href="food-categories.php" class="hvr-grow">Categories</a></li>
		        <li><a href="foods.php" class="hvr-grow">Foods</a></li>
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +91 5446587420. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/Terraza">Home</a></li>
	        <li><a href="/about-terazza-restaurant.php">About Us</a></li>
